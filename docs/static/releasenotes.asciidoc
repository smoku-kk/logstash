...
=== Logstash Commits between 7.3 and 7.2.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.2.1..7.3"

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.2.1..7.3 *.release"
